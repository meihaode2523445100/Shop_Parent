...
public class ProjectConfig {
    ...
    //Redis信息
    public static final String REDISHOST="47.100.228.93";
    ...
    //短信配置
    public static final String SMSKEY="6ea6a19621eb2eadd24c3b005d4d6cf5";
    public static final String SMSTEMPID="165466";
